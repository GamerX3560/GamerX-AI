#!/usr/bin/env python3
"""Writes the complete ChatRepository.kt with agentic shell executor."""
import os

content = r'''package com.gamerx.ai.data.repository
...
path = "/home/gamerx/GamerXAI/app/src/main/java/com/gamerx/ai/data/repository/ChatRepository.kt"
